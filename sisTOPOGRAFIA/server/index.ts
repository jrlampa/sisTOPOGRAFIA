...
// Protected by Auth and Quota validators to ensure free-tier constraints.
app.post('/api/dxf', requireAuth, checkQuota, largeBodyParser, dxfRateLimiter, (req, res) => dxfController.generate(req, res));
