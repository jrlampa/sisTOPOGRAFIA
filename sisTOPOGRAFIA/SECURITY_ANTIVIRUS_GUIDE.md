...
1. **Diretórios**:
   ```
   C:\Users\[usuario]\[caminho]\myworld\sisTOPOGRAFIA\node_modules
   C:\Users\[usuario]\[caminho]\myworld\sisTOPOGRAFIA\public\dxf
   C:\Users\[usuario]\[caminho]\myworld\sisTOPOGRAFIA\cache
   C:\Users\[usuario]\[caminho]\myworld\sisTOPOGRAFIA\py_engine
   ```
...
Add-MpPreference -ExclusionPath "C:\Users\[usuario]\[caminho]\myworld\sisTOPOGRAFIA"
...
3. Adicionar os seguintes diretórios:
   - Diretório raiz do projeto: `myworld/sisTOPOGRAFIA`
   - Node modules: `myworld/sisTOPOGRAFIA/node_modules`
   - Python engine: `myworld/sisTOPOGRAFIA/py_engine`
