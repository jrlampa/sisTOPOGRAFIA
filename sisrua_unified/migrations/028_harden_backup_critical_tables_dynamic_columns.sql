-- Migration: 028_harden_backup_critical_tables_dynamic_columns.sql
-- Purpose:
--   Make private.backup_critical_tables resilient to schema drift by using
--   dynamic shared-column projection between public tables and backup snapshots.
...
BEGIN
  ...
  LOOP
    ...
    -- Keep existing retention intent for bt_export_history logical backup volume.
...
BEGIN
  IF EXISTS (
    ...
    VALUES ('028_harden_backup_critical_tables_dynamic_columns.sql')
