...
import {
  findTransformerConflictsWithoutSectioning as findTransformerConflictsWithoutSectioningInternal,
  type BtTransformerConflictGroup,
} from "./btTransformerConflicts";
...
export const findTransformerConflictsWithoutSectioning = (
  ...
  return findTransformerConflictsWithoutSectioningInternal(topology);
};
