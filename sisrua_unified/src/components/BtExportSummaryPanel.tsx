...
import { BtExportSummary, BtExportHistoryEntry } from '../types';

interface BtExportSummaryPanelProps {
  latestBtExport: BtExportSummary | null;
...
const BtExportSummaryPanel: React.FC<BtExportSummaryPanelProps> = ({
  latestBtExport, btExportHistory, onExportJson, onExportCsv, onClearHistory
}) => {
  if (!latestBtExport && btExportHistory.length === 0) return null;
  return (
...
export default BtExportSummaryPanel;
