...
export const PortalLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { label: 'Equipe', icon: Users, path: '/portal/team' },
    {
      ...
      icon: Calculator,
      path: '/portal/finance',
      enabled: flags.enableFinOpsDashboard,
    },
    ...
    <div className="flex h-screen w-full bg-slate-950 overflow-hidden font-sans">
      ...
      >
        ...
        <div className="p-6 flex items-center gap-3">
          ...
          {isSidebarOpen && (
            <span className="text-white font-black tracking-tighter text-lg uppercase italic">
              sisRUA <span className="text-indigo-500">v3</span>
            </span>
          )}
        </div>
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col relative overflow-hidden bg-[url('/grid-subtle.svg')] bg-repeat">
        {/* Header */}
        <header className="h-16 border-b border-white/5 flex items-center justify-between px-8 bg-slate-900/50 backdrop-blur-xl z-40">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-sm font-black text-white/50 uppercase tracking-[0.3em]">
              IM3 Brasil / <span className="text-white">Portal do Engenheiro</span>
            </h2>
          </div>
