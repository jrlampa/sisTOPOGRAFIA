  ...
  return (
    ...
    >
      <button
        ...
        title="Desfazer (Clique direito para histórico)"
        aria-label="Desfazer"
      >
        <Undo2 size={18} />
      </button>
      ...
      <button
        ...
        title="Refazer (Clique direito para histórico)"
        aria-label="Refazer"
      >
        <Redo2 size={18} />
      </button>
            ...
            <div className="space-y-0.5">
              ...
              {recentPast.map((entry, i) => (
                <button
                  ...
                  className="flex w-full items-center gap-3 px-3 py-2 text-left text-xs font-medium text-slate-600 hover:bg-slate-50 dark:text-slate-300 dark:hover:bg-white/5 rounded-lg transition-colors"
                >
