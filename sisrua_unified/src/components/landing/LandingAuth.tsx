        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-400 max-w-lg leading-relaxed font-medium">
              Conecte-se com sua identidade corporativa para acessar projetos topográficos, análises
              de conformidade e o motor de design generativo.
            </p>
                ...
                {isSuccess || user ? (
                  ...
                  >
                    ...
                    <p className="text-slate-400 text-sm font-medium mb-8">
                      Redirecionando para o seu portal corporativo...
                    </p>
                  ...
                  <motion.form key="form" onSubmit={handleLogin} className="space-y-6">
                    <div className="space-y-4">
                      <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                          ...
                          />
                          <Mail
                            className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-600 group-focus-within:text-cyan-400 transition-colors"
                            size={18}
                          />
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-center gap-2 pt-2">
                      ...
                      <a
                        href="#"
                        className="text-[10px] font-black text-indigo-400 hover:text-cyan-400 transition-colors uppercase tracking-widest"
                      >
                        Recuperar
                      </a>
                    </div>
                    ...
                    <div className="pt-4">
                      <OAuthButtons direction="vertical" showLabel={true} showDivider={true} />
                    </div>
                  </motion.form>
                )}
              </AnimatePresence>
