        ...
        <div className="grid grid-cols-1 gap-2">
          ...
          >
            ...
            >
              <PencilRuler
                size={14}
                className={
                  settings.layers.dimensions ? 'text-blue-400' : 'text-slate-600'
                }
              />
              <span
                className={
                  settings.layers.dimensions ? 'text-blue-200' : 'text-slate-500'
                }
              >
          ...
          >
            <div className="p-2 bg-slate-800 rounded-md">
              <Grid3X3
                size={18}
                className={settings.layers.grid ? 'text-white' : 'text-slate-500'}
              />
            </div>
            <button
