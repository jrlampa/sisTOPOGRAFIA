/* eslint-disable react-refresh/only-export-components -- intentional: utilities and constants co-located with NumericTextInput component */
...
export const nextId = (prefix: string): string =>
  `${prefix}${Date.now()}${Math.floor(Math.random() * LEGACY_ID_ENTROPY)}`;
