...
class DXFBtMixin:
    ...
    def _draw_bt_pole(self, pole):
        ...
        bim_attribs = {
            ...
            "BIM_ESTRUTURA": ", ".join(filter(None, [
                structs.get("si1"), structs.get("si2"), 
                structs.get("si3"), structs.get("si4")
            ])) or "-"
        }
    ...
    def _draw_bt_edge(self, edge):
        ...
        self.msp.add_blockref("BT_CABO_META", (mid_x, mid_y)).add_auto_attribs(bim_edge_attribs)
