...
class DXFGenerator:
    ...
    def add_bt_summary(self):
        ...
        critical_pole = self.bt_context.get('criticalPole') if isinstance(self.bt_context.get('criticalPole'), dict) else {}
        ...
        self.msp.add_line((start_x, top_y - 8), (start_x + panel_width, top_y - 8), dxfattribs={'layer': 'QUADRO', 'color': 7})
