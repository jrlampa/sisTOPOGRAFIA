...
OBRIGATÓRIO: Criar/Ler o RAG/MEMORY.md + CAC.md para entender o contexto do projeto antes de qualquer ação;
...
Versionamento único e propagado em todo o projeto.
...
Docker First: Manter e utilizar Dockerfile, docker-compose.yml, .dockerignore e .gitignore sempre atualizados e otimizados;
...
Interface UI/UX / GUI deve estar 100% em pt-BR como principal e multilíngues com en-US e es-ES como opções;
...
Finalização: Ao terminar uma task: (1) executar suite de testes, (2) verificar cobertura, (3) realizar o commit na branch dev, (4) atualizar o RAG/MEMORY/CAC.md.
